// @ts-nocheck
// from https://github.com/mohayonao/wav-encoder/blob/master/index.js
"use strict";

function encodeSync(audioData, opts?: any): Uint8Array {
  opts = opts || {};
...
function encode(audioData, opts?: any): any {
