...
class AudioEffects {
    ...
    constructor (buffer: AudioBuffer, name: ValueOf<typeof effectTypes>, trimStart: number, trimEnd: number) {
    ...
    process (done: (renderedBuffer: AudioBuffer, trimStart: number, trimEnd: number) => void) {
